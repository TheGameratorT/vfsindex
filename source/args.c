...
const char *gengetopt_args_info_purpose = "VFS Indexer";

const char *gengetopt_args_info_usage = "Usage: vfsindex [OPTION]...";
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVi:o:y", long_options, &option_index);
