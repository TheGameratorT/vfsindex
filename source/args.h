...
#define CMDLINE_PARSER_PACKAGE "vfsindex"
#endif

#ifndef CMDLINE_PARSER_PACKAGE_NAME
/** @brief the complete program name (used for help and version) */
#define CMDLINE_PARSER_PACKAGE_NAME "vfsindex"
#endif
...
struct gengetopt_args_info
{
  ...
  char * input_arg;	/**< @brief Input path.  */
  char * input_orig;	/**< @brief Input path original value given at command line.  */
  const char *input_help; /**< @brief Input path help description.  */
